    ...
    return (
      <div className="ui container">
        <h4 class="ui horizontal divider header">
          ...
          {this.state.team1roster.length !== 0 && this.state.team2roster.length !== 0 ? <NavLink to={"/nba_frontend/simulate/" + this.state.team1roster[0].season.id + "/" + this.state.team2roster[0].season.id}><button className="ui inverted orange button">Start Simulation</button></NavLink> : null}
      </div>
    )
  }
}
